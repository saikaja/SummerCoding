...
namespace SY.OnlineApp.InteractiveAPI.Controllers
{
    ...
    {
        private readonly IInteractiveITypeInformationService _typeInformationService;
        private readonly IInteractiveTypeUtilService _typeUtilService;

        public TypeInformationsController(IInteractiveITypeInformationService typeInformationService, IInteractiveTypeUtilService typeUtilService)
        {
